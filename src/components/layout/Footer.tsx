    ...
    <footer className="footer pt-12 pb-6">
      <div className="vintage-container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* About section */}
          <div>
            <h3 className="text-lg font-medium mb-4 text-theme-foreground">{storeSettings.name}</h3>
            <p className="text-sm text-theme-foreground opacity-80 mb-4">
          ...
          {/* Quick links */}
          <div>
            <h3 className="text-lg font-medium mb-4 text-theme-foreground">Links Rápidos</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/" className="text-theme-foreground opacity-80 hover:text-theme-primary transition-colors">
                  Página Inicial
                </Link>
              </li>
              <li>
                <Link to="/products" className="text-theme-foreground opacity-80 hover:text-theme-primary transition-colors">
                  Produtos
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-theme-foreground opacity-80 hover:text-theme-primary transition-colors">
                  Sobre Nós
                </Link>
              </li>
              <li>
                <Link to="/admin" className="text-theme-foreground opacity-80 hover:text-theme-primary transition-colors">
                  Área Administrativa
                </Link>
              </li>
            </ul>
          ...
          {/* Contact section */}
          <div>
            <h3 className="text-lg font-medium mb-4 text-theme-foreground">Contato</h3>
            <p className="text-sm text-theme-foreground opacity-80 mb-2">
            ...
            <div className="flex space-x-4 mt-4">
              {storeSettings.instagram_link ? (
                ...
                <span className="text-theme-foreground opacity-50 cursor-not-allowed">
        ...
        <div className="text-center text-xs text-theme-foreground opacity-60">
